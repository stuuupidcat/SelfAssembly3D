...
bool BlueDescendCompare::operator() (const LightGrid lg1, const LightGrid lg2) {
    return lg1.blue_intensity > lg2.blue_intensity;
}


bool BlueDescendRedAscendCompare::operator() (const LightGrid lg1, const LightGrid lg2) {
...
bool RedAscendCompare::operator() (const LightGrid lg1, const LightGrid lg2) {
    return lg1.red_intensity < lg2.red_intensity;
}